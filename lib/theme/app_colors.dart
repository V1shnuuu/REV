...
class ReviveColors extends ThemeExtension<ReviveColors> {
  ...
  ReviveColors lerp(ThemeExtension<ReviveColors>? other, double t) {
    ...
    return ReviveColors(
      ...
      urgentActionPressed: Color.lerp(
        urgentActionPressed,
        other.urgentActionPressed,
        t,
      )!,
      onUrgentAction: Color.lerp(onUrgentAction, other.onUrgentAction, t)!,
      urgentActionSubtle: Color.lerp(
        urgentActionSubtle,
        other.urgentActionSubtle,
        t,
      )!,
      inRangeSuccess: Color.lerp(inRangeSuccess, other.inRangeSuccess, t)!,
      onInRangeSuccess: Color.lerp(
        onInRangeSuccess,
        other.onInRangeSuccess,
        t,
      )!,
      inRangeSuccessSubtle: Color.lerp(
        inRangeSuccessSubtle,
        other.inRangeSuccessSubtle,
        t,
      )!,
      belowRangeWarning: Color.lerp(
        belowRangeWarning,
        other.belowRangeWarning,
        t,
      )!,
      aboveRangeWarning: Color.lerp(
        aboveRangeWarning,
        other.aboveRangeWarning,
        t,
      )!,
